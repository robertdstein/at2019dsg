...
res = astropy.io.ascii.read("at2019dsg_RB_fit_p3.0.dat")
R_single = np.array([list(res["R_cm"]), list(res["eR_cm"])]).T
B_single = np.array([list(res["B_Gauss"]), list(res["eB_Gauss"])]).T
...
# make nice SED plot
plt.close()
f1 = plt.figure(figsize=(fig_width * 2., fig_width * 1.5))
